...
import pandas as pd
from . import SubmittedJob, ClusterMethod

LOG = logging.getLogger(__name__)


def schedule_cluster_samples(profiles: List[str], cluster_method: ClusterMethod) -> SubmittedJob:
    ...
    job = redis.allele.enqueue(TASK, profile=profile_tsv, method=cluster_method.value, job_timeout='30m') 
