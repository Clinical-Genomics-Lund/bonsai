...
from ..models.location import LocationOutputDatabase, LocationInputCreate, LocationInputDatabase, GeoJSONPolygon
...
async def get_locations(db: Database, limit: int | None = None, skip: int = 0) -> List[LocationOutputDatabase]:
...
async def create_location(db: Database, location: LocationInputCreate) -> LocationOutputDatabase:
...
async def get_locations_within_bbox(db: Database, bbox: GeoJSONPolygon) -> List[LocationOutputDatabase]:
