...
function  D3MSMetadataTable(tree,context_menu){
	...
	this._setupDiv();	
	this.columns = [
		{id: "Selected", name: "<img src='tree/static/js/img/tick.png'>", field: "__selected", width: 30, maxWidth:30, minWidth:30, formatter: Slick.Formatters.Checkmark, sortable: true, editor: Slick.Editors.Checkbox, prop:{category:'character', group_num:30, group_order:'occurence'}},
